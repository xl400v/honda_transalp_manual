...
When the needle begins to move above the C \(Cold\) mark, the engine is warm enough for the motorcycle to be ridden. The normal operating temperature range is within the section between the H and C marks. If the needle reaches the H \(Hot\) mark, stop the engine and check the reserve tank coolant level. Read [\[see page and scroll\]](https://xl400v.gitbook.io/honda-transalp/owners-manual/03/03#inspection) and do not ride the motorcycle until the problem has been corrected.
